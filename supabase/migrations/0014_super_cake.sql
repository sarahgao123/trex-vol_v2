/*
  # Fix volunteer handling

  1. Changes
    - Update process_initial_volunteers function to properly handle volunteer names
    - Update slot_details view to include all volunteer information
*/
